...
<html>
<head>
<title>Branch Updated Successfully</title>
</head>
<body>
	<h2>Branch Updated Successfully</h2>
	<p>Your branch has been updated successfully.</p>
	...
	<form action="${pageContext.request.contextPath}/admin/bank/updateBranch" method="get">
		<button type="submit">Update Another Branch</button>
	</form>
</body>
</html>
